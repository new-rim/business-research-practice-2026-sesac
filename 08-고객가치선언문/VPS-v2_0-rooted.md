...
> | **흡수한 선행 리서치** | 04 시장분석·아이디어 정의서 / 05 페르소나·스펙트럼·여정지도 / 06 Pain 인벤토리·AOS·DOS·사분면 / 07 JTBD 인터뷰 설계·모의 9건 / 08 경쟁사 9종·가치목표 3안 / 09 Phase 0 법률 검토 |
...
flowchart TD
    subgraph INPUT ["선행 분석 입력 (본 문서에 전량 흡수)"]
        ...
        L["09 Phase 0 법률 검토<br/>(전금법·사행성·약관 R1~R8)"]
    end
