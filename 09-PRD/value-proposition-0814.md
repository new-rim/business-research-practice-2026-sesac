...
> | 항목 | 값 |
> |---|---|
> | **문서 ID** | `value-proposition-0814` — **PRD의 입력 기준본이자 고객가치선언 확정본** |
> | **이 파일의 자리** | 09-PRD 단계의 **단일 입력.** 원래 08 고객가치선언문 챕터에 `VPS-v2.0-rooted`로 있었으나, **PRD 작성의 기준본**이므로 09로 옮겼다. 다른 리서치 문서를 열지 않아도 되도록 04~08과 법률 검토의 지식이 전부 흡수돼 있다 |
