...
> - 2026-08-10 (2차) — **C-03 박서연을 '목표 미달 반복'으로 재정의** / A-05 신설 (13종 → 14종)
> - 2026-08-10 (3차) — **C-02 김도현을 무료 인증방 경험만으로 정리**(유료 경험 삭제) / C-04 대체 솔루션 검토 행 삭제 / **C-05 최민지에 '과정을 남기고 싶은 욕구' 반영** / **A-04 송재현을 '어긋남'에서 '무료 개인 트랙의 근거'로 재해석** / **A-05를 여민석(사내 건강 챌린지 운영 담당자)으로 교체** / **E-01 설계 구멍을 '계약 중 변경 불가'에서 '계약 전 진단 부재'로 정정** (14종 유지)
...
| — | → | **A-05 여민석** | 🆕 **피드백 반영 신설(3차)** — 사내 건강 챌린지 운영 담당자. §6 후보 풀 '기업 복지 담당자'에서 승격 |
...
| 단계 | 채울 산출물 | 입력 |
|---|---|---|
| **②** 2차 평가 | Core / Adjacent / Extreme / Non-user **각 1명 = 대표 4종** | 본 문서 14명 + §6 후보 풀 6명 |
...
| 3 | **Adjacent 대표를 누구로 할 것인가 — 5명으로 늘었다** | 다섯 축(다른 도구·다른 목적·다른 보상·다른 무대·다른 재원)이 각각 다른 수익원을 향한다. **송재현은 무료 획득, 여민석은 조직 예산, 나머지는 R2 참가비** 쪽이라 대표 선정이 곧 수익 축 선택이 된다 |
| 3-1 | **여민석(조직 계약)을 스펙트럼에 두는 것이 맞는가** | 사용자와 구매자가 분리된 B2B라, 케어 리포터(P8)를 후순위로 내린 사유와 겹친다. 본 문서는 *"제품이 같고 재원만 다르다"*는 이유로 병행 경로로 판단했으나 **②에서 뒤집힐 수 있다** |
...
8. **A-05 여민석의 조직 예산 경로는 전례를 대입한 추론이다.** 사내 건강 챌린지·공공 캠페인(손목닥터9988 참여자 200만 `[실측]`)이 실재하는 것은 확인됐으나, **"회사가 팟을 채우는" 정산 구조가 법적·회계적으로 성립하는지는 검토하지 않았다.** 발견 7 전체가 이 가정에 걸려 있다.
9. **3차 개정에서 A-05를 교체하며 직전 판의 발견 1건이 함께 내려갔다.** 구 A-05가 제기했던 *"자동 편집 회고본은 셋로그가 이미 제공하므로 차별점이 아닐 수 있다"*는 지적은 **인물이 빠지면서 문서에서 사라졌다.** 사실 여부와 무관하게 **포지셔닝 비교표 검증 과제로는 남아 있다.**
